...
# Support custom branch of the js-sdk. This also helps us build images of matron-web develop.
...
# HTTP listen port
ENV MATRON_WEB_PORT=80

HEALTHCHECK --start-period=5s CMD wget -q --spider http://localhost:$MATRON_WEB_PORT/config.json
