/*
Copyright 2024 Matron Contributors.
...
// see matron-web config.md for docs, or the IConfigOptions interface for dev docs
export const DEFAULTS: DeepReadonly<IConfigOptions> = {
    brand: "Matron",
    help_url: "https://matron.chat/help",
    help_encryption_url: "https://matron.chat/help#encryption",
    help_key_storage_url: "https://matron.chat/help#encryption5",
    ...
    desktopBuilds: {
        ...
        url: "https://matron.chat/get-started",
    },

    feedback: {
        existing_issues_url:
            "https://github.com/matronhq/matron-web/issues?q=is%3Aopen+is%3Aissue+sort%3Areactions-%2B1-desc",
        new_issue_url: "https://github.com/matronhq/matron-web/issues/new/choose",
    },

    desktop_builds: {
        available: true,
        logo: "vector-icons/1024.png",
        url: "https://matron.chat/download",
        url_macos: "https://packages.matron.chat/desktop/install/macos/Matron.dmg",
        url_win64: "https://packages.matron.chat/desktop/install/win32/x64/Matron%20Setup.exe",
        url_win64arm: "https://packages.matron.chat/desktop/install/win32/arm64/Matron%20Setup.exe",
        url_linux: "https://matron.chat/download#linux",
    },
    mobile_builds: {
        ios: "https://apps.apple.com/app/matron/id1083446067",
        android: "https://play.google.com/store/apps/details?id=chat.matron.app",
        fdroid: "https://f-droid.org/repository/browse/?fdid=chat.matron.app",
    },
};
