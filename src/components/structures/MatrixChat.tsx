...
export default class MatrixChat extends React.PureComponent<IProps, IState> {
    ...
    private onWillStartClient(): void {
        ...
        // https://github.com/matronhq/matron-web/issues/3307#issuecomment-282895568
    ...
    public showScreen(screen: string, params?: Record<string, any>): void {
        ...
        if (screen === "register") {
            ...
            // TODO: Handle encoded room/event IDs: https://github.com/matronhq/matron-web/issues/9149
            ...
            const payload: ViewRoomPayload = {
                ...
                // See https://github.com/matronhq/matron-web/issues/15157
                oob_data: {
    ...
    private getFragmentAfterLogin(): string {
        ...
        if (
            ...
            // XXX: workaround for https://github.com/matronhq/matron-web/issues/11643 causing a login-loop
