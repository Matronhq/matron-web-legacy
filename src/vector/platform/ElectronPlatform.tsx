...
export default class ElectronPlatform extends BasePlatform {
    ...
    public supportsJitsiScreensharing(): boolean {
        // See https://github.com/matronhq/matron-web/issues/4880
        return false;
    }
    ...
    public get baseUrl(): string {
        ...
        return (SdkConfig.get() as unknown as Record<string, string>)["web_base_url"] ?? "https://app.matron.chat";
    }

    public get defaultOidcClientUri(): string {
        // Default to matron.chat as our scheme `chat.matron.desktop` is within its scope on default MAS policies
        return "https://matron.chat";
    }
