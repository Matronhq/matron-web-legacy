...
export default class Markdown {
     ...
     * See: https://github.com/matronhq/matron-web/issues/4674
     * @param parsed
     */
    ...
    public isPlainText(): boolean {
        ...
        while ((ev = walker.next())) {
            ...
            if (TEXT_NODES.indexOf(node.type) > -1) {
                ...
                // See https://github.com/matronhq/matron-web/issues/7631
    ...
    public toHTML({ externalLinks = false } = {}): string {
        const renderer = new commonmark.HtmlRenderer({
            ...
            // (https://github.com/matronhq/matron-web/issues/3154)
            softbreak: "<br />",
        });
     ...
     * markdown syntax
     * (to fix https://github.com/matronhq/matron-web/issues/2870).
     *
