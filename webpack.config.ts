...
//   this can be helpful if your deployment has redirects for old bundles, such as develop.matron.chat.
...
export default (env: string, argv: Record<string, any>): webpack.Configuration => {
    ...
    //      (called to build prod, nightly and develop.matron.chat)
    ...
    //      (called to build nightly and develop.matron.chat)
    ...
    return {
        ...
        plugins: [
            ...
            // Due to issues such as https://github.com/matronhq/matron-web/issues/25277 we should retry chunk loading
...
function getAssetOutputPath(url: string, resourcePath: string): string {
    ...
    /**
     * Only needed for https://github.com/matronhq/matron-web/pull/15939
