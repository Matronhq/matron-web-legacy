...
1. Located in [`shared-components`](https://github.com/matronhq/matron-web/tree/develop/packages/shared-components). Develop it in storybook!
...
// https://github.com/matronhq/matron-web/blob/develop/packages/shared-components/src/ViewModel.ts
...
1. A View model is a class extending [`BaseViewModel`](https://github.com/matronhq/matron-web/blob/develop/src/viewmodels/base/BaseViewModel.ts).
...
4. Call [`this.snapshot.merge(...)`](https://github.com/matronhq/matron-web/blob/develop/packages/shared-components/src/viewmodel/Snapshot.ts#L32) to only update part of the snapshot.
