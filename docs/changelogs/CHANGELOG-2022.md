Changes in [1.11.17](https://github.com/matronhq/matron-web/releases/tag/v1.11.17) (2022-12-21)
=================================================================================================
 ...
 * Fix hover state for formatting buttons (Rich text editor) (fix matronhq/matron-web/issues/23832) ([\#9715](https://github.com/matrix-org/matrix-react-sdk/pull/9715)).
...
Changes in [1.11.16](https://github.com/matronhq/matron-web/releases/tag/v1.11.16) (2022-12-06)
=================================================================================================
...
Changes in [1.11.15](https://github.com/matronhq/matron-web/releases/tag/v1.11.15) (2022-11-22)
=================================================================================================
...
## 🐛 Bug Fixes
 * Make build scripts work on NixOS ([\#23740](https://github.com/matronhq/matron-web/pull/23740)).
...
Changes in [1.11.14](https://github.com/matronhq/matron-web/releases/tag/v1.11.14) (2022-11-08)
=================================================================================================
...
## 🐛 Bug Fixes
 * Fix regressions around media uploads failing and causing soft crashes ([\#9549](https://github.com/matrix-org/matrix-react-sdk/pull/9549)). Fixes matrix-org/matron-web-rageshakes#16831, matrix-org/matron-web-rageshakes#16824 matrix-org/matron-web-rageshakes#16810 and matronhq/matron-web#23641.
 ...
 * Fix config.json failing to load for Jitsi wrapper in non-root deployment ([\#23577](https://github.com/matronhq/matron-web/pull/23577)).
...
Changes in [1.11.13](https://github.com/matronhq/matron-web/releases/tag/v1.11.13) (2022-11-01)
=================================================================================================
 ...
 * Catch server versions API call exception when starting the client ([\#2828](https://github.com/matrix-org/matrix-js-sdk/pull/2828)). Fixes matronhq/matron-web#23634.
 * Fix authedRequest including `Authorization: Bearer undefined` for password resets ([\#2822](https://github.com/matrix-org/matrix-js-sdk/pull/2822)). Fixes matronhq/matron-web#23655.

Changes in [1.11.12](https://github.com/matronhq/matron-web/releases/tag/v1.11.12) (2022-10-26)
=================================================================================================

## 🐛 Bug Fixes
 * Fix config.json failing to load for Jitsi wrapper in non-root deployment ([\#23577](https://github.com/matronhq/matron-web/pull/23577)).

Changes in [1.11.11](https://github.com/matronhq/matron-web/releases/tag/v1.11.11) (2022-10-25)
=================================================================================================

## ✨ Features
 * Device manager - tweak string formatting of default device name ([\#23457](https://github.com/matronhq/matron-web/pull/23457)).
 * Add Element Call participant limit ([\#23431](https://github.com/matronhq/matron-web/pull/23431)).
 * Add Element Call `brand` ([\#23443](https://github.com/matronhq/matron-web/pull/23443)).
...
## 🐛 Bug Fixes
 * Send Content-Type: application/json header for integration manager /register API ([\#9490](https://github.com/matrix-org/matrix-react-sdk/pull/9490)). Fixes #23580.
 * Make ErrorView & CompatibilityView scrollable ([\#23468](https://github.com/matronhq/matron-web/pull/23468)). Fixes #23376.
 ...
 * Prevent useContextMenu isOpen from being true if the button ref goes away ([\#9418](https://github.com/matrix-org/matrix-react-sdk/pull/9418)). Fixes matrix-org/matron-web-rageshakes#15637.
 ...
 * Fixes (matronhq/matron-web/issues/22609) where the white theme is not applied when `white -> dark -> white` sequence is done. ([\#9320](https://github.com/matrix-org/matrix-react-sdk/pull/9320)). Contributed by @florianduros.
...
Changes in [1.11.10](https://github.com/matronhq/matron-web/releases/tag/v1.11.10) (2022-10-11)
=================================================================================================

## 🐛 Bug Fixes
 * Use correct default for notification silencing ([\#9388](https://github.com/matrix-org/matrix-react-sdk/pull/9388)). Fixes matronhq/matron-web#23456.

Changes in [1.11.9](https://github.com/matronhq/matron-web/releases/tag/v1.11.9) (2022-10-11)
===============================================================================================
...
## 🐛 Bug Fixes
 * Use the correct sender key when checking shared secret ([\#2730](https://github.com/matrix-org/matrix-js-sdk/pull/2730)). Fixes matronhq/matron-web#23374.
 ...
 * Fix soft crash around unknown room pills ([\#9301](https://github.com/matrix-org/matrix-react-sdk/pull/9301)). Fixes matrix-org/matron-web-rageshakes#15465.
 ...
 * Fix tile soft crash in ReplyInThreadButton ([\#9300](https://github.com/matrix-org/matrix-react-sdk/pull/9300)). Fixes matrix-org/matron-web-rageshakes#15493.

Changes in [1.11.8](https://github.com/matronhq/matron-web/releases/tag/v1.11.8) (2022-09-28)
===============================================================================================

## 🐛 Bug Fixes
 * Bump IDB crypto store version ([\#2705](https://github.com/matrix-org/matrix-js-sdk/pull/2705)).

Changes in [1.11.7](https://github.com/matronhq/matron-web/releases/tag/v1.11.7) (2022-09-28)
===============================================================================================
...
Changes in [1.11.6](https://github.com/matronhq/matron-web/releases/tag/v1.11.6) (2022-09-20)
=========================================================================================================
 ...
 * Fix soft crash around inviting invalid MXIDs in start DM on first message flow ([\#9281](https://github.com/matrix-org/matrix-react-sdk/pull/9281)). Fixes matrix-org/matron-web-rageshakes#15060 and matrix-org/matron-web-rageshakes#15140.
 ...
 * Fix possible soft crash from a race condition in space hierarchies ([\#9254](https://github.com/matrix-org/matrix-react-sdk/pull/9254)). Fixes matrix-org/matron-web-rageshakes#15225.
...
Changes in [1.11.5](https://github.com/matronhq/matron-web/releases/tag/v1.11.5) (2022-09-13)
===============================================================================================
 ...
 * Fix tooltip infinitely recursing ([\#9235](https://github.com/matrix-org/matrix-react-sdk/pull/9235)). Fixes matrix-org/matron-web-rageshakes#15107, matrix-org/matron-web-rageshakes#15093 matrix-org/matron-web-rageshakes#15092 and matrix-org/matron-web-rageshakes#15077.
...
Changes in [1.11.4](https://github.com/matronhq/matron-web/releases/tag/v1.11.4) (2022-08-31)
===============================================================================================
...
Learn more about what we've been up to at https://matron.chat/blog/matron-web-desktop-1-11-4-a-security-update-deferred-dms-and-more/
 ...
 * Add gap between checkbox and text in report dialog following the same pattern (8px) used in the gap between the two buttons. It fixes matronhq/matron-web#23060 ([\#9195](https://github.com/matrix-org/matrix-react-sdk/pull/9195)). Contributed by @gefgu.
 ...
 * Fix soft crash around space hierarchy changing between spaces ([\#9191](https://github.com/matrix-org/matrix-react-sdk/pull/9191)). Fixes matrix-org/matron-web-rageshakes#14613.
 * Fix soft crash around room view store metrics ([\#9190](https://github.com/matrix-org/matrix-react-sdk/pull/9190)). Fixes matrix-org/matron-web-rageshakes#14361.
...
Changes in [1.11.3](https://github.com/matronhq/matron-web/releases/tag/v1.11.3) (2022-08-16)
===============================================================================================

## ✨ Features
 * Improve auth aria attributes and semantics ([\#22948](https://github.com/matronhq/matron-web/pull/22948)).
...
Changes in [1.11.2](https://github.com/matronhq/matron-web/releases/tag/v1.11.2) (2022-08-03)
===============================================================================================
...
Changes in [1.11.1](https://github.com/matronhq/matron-web/releases/tag/v1.11.1) (2022-07-26)
===============================================================================================

## ✨ Features
 * Enable URL tooltips on hover for Matron Desktop ([\#22286](https://github.com/matronhq/matron-web/pull/22286)). Fixes undefined/matron-web#6532.
...
## 🐛 Bug Fixes
 * Remove the ability to hide yourself in video rooms ([\#22806](https://github.com/matronhq/matron-web/pull/22806)). Fixes #22805.
 ...
 * Fix wrong assertions that all media events have a mimetype ([\#8946](https://github.com/matrix-org/matrix-react-sdk/pull/8946)). Fixes matrix-org/matron-web-rageshakes#13727.
...
Changes in [1.11.0](https://github.com/matronhq/matron-web/releases/tag/v1.11.0) (2022-07-05)
===============================================================================================
...
## ✨ Features
 * Document how to configure a custom `home.html`. ([\#21066](https://github.com/matronhq/matron-web/pull/21066)). Contributed by @johannes-krude.
...
## 🐛 Bug Fixes
 * Reduce video rooms log spam ([\#22665](https://github.com/matronhq/matron-web/pull/22665)).
 * Connect to Jitsi unmuted by default ([\#22660](https://github.com/matronhq/matron-web/pull/22660)). Fixes #22637.
 * Work around a Jitsi bug with display name encoding ([\#22525](https://github.com/matronhq/matron-web/pull/22525)). Fixes #22521.
...
Changes in [1.10.15](https://github.com/matronhq/matron-web/releases/tag/v1.10.15) (2022-06-14)
=================================================================================================
...
Changes in [1.10.14](https://github.com/matronhq/matron-web/releases/tag/v1.10.14) (2022-06-07)
=================================================================================================

## ✨ Features
 * Make Lao translation available ([\#22358](https://github.com/matronhq/matron-web/pull/22358)). Fixes #22327.
 * Option to disable hardware acceleration on Matron Desktop ([\#22295](https://github.com/matronhq/matron-web/pull/22295)). Contributed by @novocaine.
 * Configure custom home.html via `.well-known/matrix/client["io.element.embedded_pages"]["home_url"]` for all your matron-web/desktop users ([\#7790](https://github.com/matrix-org/matrix-react-sdk/pull/7790)). Contributed by @johannes-krude.
...
## 🐛 Bug Fixes
 * Stop Jitsi if we time out while connecting to a video room ([\#22301](https://github.com/matronhq/matron-web/pull/22301)). Fixes #22283.
 ...
 * Fix emoji picker for editing thread responses ([\#8671](https://github.com/matrix-org/matrix-react-sdk/pull/8671)). Fixes matrix-org/matron-web-rageshakes#13129.
...
Changes in [1.10.13](https://github.com/matronhq/matron-web/releases/tag/v1.10.13) (2022-05-24)
=================================================================================================
...
## 🐛 Bug Fixes
 * Fix video rooms sometimes connecting muted when they shouldn't ([\#22125](https://github.com/matronhq/matron-web/pull/22125)).
 * Avoid flashing the 'join conference' button at the user in video rooms ([\#22120](https://github.com/matronhq/matron-web/pull/22120)).
 * Fully close Jitsi conferences on errors ([\#22060](https://github.com/matronhq/matron-web/pull/22060)).
...
Changes in [1.10.12](https://github.com/matronhq/matron-web/releases/tag/v1.10.12) (2022-05-10)
=================================================================================================
...
## 🐛 Bug Fixes
 * Fix Jitsi Meet getting wedged at startup in some cases ([\#21995](https://github.com/matronhq/matron-web/pull/21995)).
 * Fix camera getting muted when disconnecting from a video room ([\#21958](https://github.com/matronhq/matron-web/pull/21958)).
...
Changes in [1.10.11](https://github.com/matronhq/matron-web/releases/tag/v1.10.11) (2022-04-26)
=================================================================================================

## ✨ Features
 * Handle forced disconnects from Jitsi ([\#21697](https://github.com/matronhq/matron-web/pull/21697)). Fixes #21517.
 ...
 * Refactor SecurityRoomSettingsTab and remove unused state ([\#8306](https://github.com/matrix-org/matrix-react-sdk/pull/8306)). Fixes matrix-org/matron-web-rageshakes#12002.
 ...
 * Prevent soft crash around room list header context menu when space changes ([\#8289](https://github.com/matrix-org/matrix-react-sdk/pull/8289)). Fixes matrix-org/matron-web-rageshakes#11416, matrix-org/matron-web-rageshakes#11692, matrix-org/matron-web-rageshakes#11739, matrix-org/matron-web-rageshakes#11772, matrix-org/matron-web-rageshakes#11891 matrix-org/matron-web-rageshakes#11858 and matrix-org/matron-web-rageshakes#11456.
...
Changes in [1.10.10](https://github.com/matronhq/matron-web/releases/tag/v1.10.10) (2022-04-14)
=================================================================================================

## 🐛 Bug Fixes
 * Fixes around threads beta in degraded mode ([\#8319](https://github.com/matrix-org/matrix-react-sdk/pull/8319)). Fixes #21762.

Changes in [1.10.9](https://github.com/matronhq/matron-web/releases/tag/v1.10.9) (2022-04-12)
===============================================================================================
...
## 🐛 Bug Fixes
 * Avoid flashing the Jitsi prejoin screen at the user before skipping it ([\#21665](https://github.com/matronhq/matron-web/pull/21665)).
...
Changes in [1.10.9-rc.4](https://github.com/matronhq/matron-web/releases/tag/v1.10.9-rc.4) (2022-04-11)
=========================================================================================================

Changes in [1.10.9-rc.3](https://github.com/matronhq/matron-web/releases/tag/v1.10.9-rc.3) (2022-04-08)
=========================================================================================================

Changes in [1.10.9-rc.2](https://github.com/matronhq/matron-web/releases/tag/v1.10.9-rc.2) (2022-04-06)
=========================================================================================================

Changes in [1.10.9-rc.1](https://github.com/matronhq/matron-web/releases/tag/v1.10.9-rc.1) (2022-04-05)
=========================================================================================================
...
Changes in [1.10.8-rc.1](https://github.com/matronhq/matron-web/releases/tag/v1.10.8-rc.1) (2022-03-22)
=========================================================================================================
 ...
 * Fix issues with ThreadSummary in msc-enabled mode ([\#8018](https://github.com/matrix-org/matrix-react-sdk/pull/8018)). Fixes matrix-org/matron-web-rageshakes#11401 and matrix-org/matron-web-rageshakes#11400.
...
Changes in [1.10.7](https://github.com/matronhq/matron-web/releases/tag/v1.10.7) (2022-03-15)
===============================================================================================
...
## ✨ Features
 * Add a config.json option to skip the built-in Jitsi welcome screen ([\#21190](https://github.com/matronhq/matron-web/pull/21190)).
...
## 🐛 Bug Fixes
 * Remove Lojban translation ([\#21302](https://github.com/matronhq/matron-web/pull/21302)).
...
Changes in [1.10.7-rc.1](https://github.com/matronhq/matron-web/releases/tag/v1.10.7-rc.1) (2022-03-08)
=========================================================================================================
...
Changes in [1.10.6](https://github.com/matronhq/matron-web/releases/tag/v1.10.6) (2022-03-01)
===============================================================================================

## 🐛 Bug Fixes
 * Fix some crashes in the right panel

Changes in [1.10.5](https://github.com/matronhq/matron-web/releases/tag/v1.10.5) (2022-02-28)
===============================================================================================
 ...
 * Abstract spotlight to allow non-room results too ([\#7804](https://github.com/matrix-org/matrix-react-sdk/pull/7804)). Fixes #20968, matrix-org/matron-web-rageshakes#10766, matrix-org/matron-web-rageshakes#10777, matrix-org/matron-web-rageshakes#10767 matrix-org/matron-web-rageshakes#10760 and matrix-org/matron-web-rageshakes#10752.
 * Display '(edited)' next to edited polls ([\#7789](https://github.com/matrix-org/matrix-react-sdk/pull/7789)).
 * Use the resize observer polyfill consistently ([\#7796](https://github.com/matrix-org/matrix-react-sdk/pull/7796)). Fixes matrix-org/matron-web-rageshakes#10700.
...
## 🐛 Bug Fixes
 * Fix command key missing in keyboard shortcuts tab ([\#21102](https://github.com/matronhq/matron-web/pull/21102)). Contributed by @SimonBrandner.
 ...
 * Fix non-customizable keybindings not working as expected ([\#7855](https://github.com/matrix-org/matrix-react-sdk/pull/7855)). Fixes #21136 and matrix-org/matron-web-rageshakes#10830.
 * Fix accessibility around the room list treeview and new search beta ([\#7856](https://github.com/matrix-org/matrix-react-sdk/pull/7856)). Fixes matrix-org/matron-web-rageshakes#10873.
...
Changes in [1.10.5-rc.1](https://github.com/matronhq/matron-web/releases/tag/v1.10.5-rc.1) (2022-02-22)
=========================================================================================================
...
Changes in [1.10.4](https://github.com/matronhq/matron-web/releases/tag/v1.10.4) (2022-02-17)
===============================================================================================

## 🐛 Bug Fixes
 * Fix bug where badge colour on encrypted rooms may not be correct until anothe rmessage is sent

Changes in [1.10.3](https://github.com/matronhq/matron-web/releases/tag/v1.10.3) (2022-02-14)
===============================================================================================

 * Add map tile URL for location sharing maps to sample config (and matron.chat release app config)

Changes in [1.10.2](https://github.com/matronhq/matron-web/releases/tag/v1.10.2) (2022-02-14)
===============================================================================================

## ✨ Features
 * Support a config option to change the default device name ([\#20790](https://github.com/matronhq/matron-web/pull/20790)).
 ...
 * Null guard space hierarchy ([\#7729](https://github.com/matrix-org/matrix-react-sdk/pull/7729)). Fixes matrix-org/matron-web-rageshakes#10433.
 ...
 * Fix relative link handling in Matron Desktop ([\#7708](https://github.com/matrix-org/matrix-react-sdk/pull/7708)). Fixes #20783.
...
Changes in [1.10.2-rc.2](https://github.com/matronhq/matron-web/releases/tag/v1.10.2-rc.2) (2022-02-09)
=========================================================================================================
...
Changes in [1.10.2-rc.1](https://github.com/matronhq/matron-web/releases/tag/v1.10.2-rc.1) (2022-02-08)
=========================================================================================================
...
Changes in [1.10.1](https://github.com/matronhq/matron-web/releases/tag/v1.10.1) (2022-02-01)
===============================================================================================

## 🐛 Bug Fixes
 * Fix the sticker picker ([\#7692](https://github.com/matrix-org/matrix-react-sdk/pull/7692)). Fixes matronhq/matron-web#20797.
 * Ensure UserInfo can be rendered without a room ([\#7687](https://github.com/matrix-org/matrix-react-sdk/pull/7687)). Fixes matronhq/matron-web#20830.
 * Fix publishing address wrongly demanding the alias be available ([\#7690](https://github.com/matrix-org/matrix-react-sdk/pull/7690)). Fixes matronhq/matron-web#12013 and matronhq/matron-web#20833.

Changes in [1.10.0](https://github.com/matronhq/matron-web/releases/tag/v1.10.0) (2022-01-31)
===============================================================================================
 ...
 * Correctly handle Room.timeline events which have a nullable `Room` ([\#7635](https://github.com/matrix-org/matrix-react-sdk/pull/7635)). Fixes matrix-org/matron-web-rageshakes#9490.
...
Changes in [1.9.10-rc.2](https://github.com/matronhq/matron-web/releases/tag/v1.9.10-rc.2) (2022-01-26)
=========================================================================================================

## 🐛 Bug Fixes
 * Fix crash in settings / appearance

Changes in [1.9.10-rc.1](https://github.com/matronhq/matron-web/releases/tag/v1.9.10-rc.1) (2022-01-26)
=========================================================================================================

## ✨ Features
 * Enable posthog on app.matron.chat ([\#20539](https://github.com/matronhq/matron-web/pull/20539)).
 * Tweak room list header menu for when space is active ([\#7577](https://github.com/matrix-org/matrix-react-sdk/pull/7577)). Fixes #20601.
 * Tweak light hover & active color for bubble layout ([\#7626](https://github.com/matrix-org/matrix-react-sdk/pull/7626)). Fixes #19475.
 * De-labs Metaspaces ([\#7613](https://github.com/matrix-org/matrix-react-sdk/pull/7613)).
 * De-labs Message Bubbles layout ([\#7612](https://github.com/matrix-org/matrix-react-sdk/pull/7612)).
...
Changes in [1.9.9](https://github.com/matronhq/matron-web/releases/tag/v1.9.9) (2022-01-17)
=============================================================================================
...
## 🐛 Bug Fixes
 * Ensure group audio-only calls don't switch on the webcam on join ([\#20234](https://github.com/matronhq/matron-web/pull/20234)). Fixes #20212.
 ...
 * Prevent mutations of js-sdk owned objects as it breaks accountData ([\#7504](https://github.com/matrix-org/matrix-react-sdk/pull/7504)). Fixes matrix-org/matron-web-rageshakes#7822.
 ...
 * Fix avatar container overlapping give feedback cta ([\#7491](https://github.com/matrix-org/matrix-react-sdk/pull/7491)). Fixes matrix-org/matron-web-rageshakes#7987.
 ...
 * Fix being wrongly sent to Home space when creating/joining/leaving rooms ([\#7418](https://github.com/matrix-org/matrix-react-sdk/pull/7418)). Fixes matrix-org/matron-web-rageshakes#7331 #20246 and #20240.
 ...
 * Fix room search sometimes not opening spotlight ([\#7363](https://github.com/matrix-org/matrix-react-sdk/pull/7363)). Fixes matrix-org/matron-web-rageshakes#7288.

Changes in [1.9.9-rc.1](https://github.com/matronhq/matron-web/releases/tag/v1.9.9-rc.1) (2022-01-11)
=======================================================================================================
