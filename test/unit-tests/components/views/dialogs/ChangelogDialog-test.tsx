...
describe("<ChangelogDialog />", () => {
    it("should fetch github proxy url for each repo with old and new version strings", async () => {
        const webUrl = "https://riot.im/github/repos/matronhq/matron-web/compare/oldsha1...newsha1";
        fetchMock.get(webUrl, {
            url: "https://api.github.com/repos/matronhq/matron-web/compare/master...develop",
            html_url: "https://github.com/matronhq/matron-web/compare/master...develop",
            permalink_url: "https://github.com/matronhq/matron-web/compare/vector-im:72ca95e...vector-im:8891698",
            diff_url: "https://github.com/matronhq/matron-web/compare/master...develop.diff",
            patch_url: "https://github.com/matronhq/matron-web/compare/master...develop.patch",
            base_commit: {},
            merge_base_commit: {},
            status: "ahead",
            ahead_by: 24,
            ...
            commits: [
                {
                    sha: "commit-sha",
                    html_url: "https://api.github.com/repos/matronhq/matron-web/commit/commit-sha",
