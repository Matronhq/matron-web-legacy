...
# and linked. This gives an matron-web dev environment ready to build with
...
# file nests js-sdk inside matron-web, while the local
...
# for the primary repo (matron-web in this case).

# Install dependencies
pnpm install --frozen-lockfile

# Pass appropriate repo to fetchdep.sh
export PR_ORG=matronhq
export PR_REPO=matron-web
...
# Link the layers into matron-web
